...
func commandAssetsExampleNomad() (*asset, error) {
	...
	info := bindataFileInfo{name: "command/assets/example.nomad", size: 16064, mode: os.FileMode(420), modTime: time.Unix(1598662943, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
