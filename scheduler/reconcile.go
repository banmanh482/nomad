...
func (a *allocReconciler) computeGroup(group string, all allocSet) bool {
	...
	// * An alloc was lost
	place := a.computePlacements(tg, nameIndex, untainted, migrate, rescheduleNow, lost)
	if !existingDeployment {
...
func (a *allocReconciler) computePlacements(group *structs.TaskGroup,
	nameIndex *allocNameIndex, untainted, migrate, reschedule, lost allocSet) []allocPlaceResult {
